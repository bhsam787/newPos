            ...
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{ asset('assets/media/bg/bg-1.jpg') }});">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-center mb-15">
                        <a href="#">
                            <img src="{{ asset('assets/media/logos/main-logo.png ') }}" class="max-h-100px" alt="" />
                        </a>
                    </div>
                    <!--end::Login Header-->
                    ...
                    {{-- <div class="login-signup">
                        ...
                        <form class="form text-center" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label style="color: white;font-size: 15px;margin-top: 9px;    margin-right: 12px;">Register as a</label>
                                <div class="">
                                    <div class="radio-inline ">
                                        <label class="radio radio-success" style="color: white;font-size: 15px;">
                                            <input type="radio" name="role" checked="checked" value="1" />
                                            <span></span>
                                            Student
                                        </label>
                                        <label class="radio radio-success" style="color: white;font-size: 15px; ">
                            ...
                            <div class="form-group">
                                <input class="@error('name') is-invalid @enderror form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="text" placeholder="Fullname"
                                  name="name" value="{{ old('name') }}" required autocomplete="name" autofocus />
                            </div>
                            <div class="form-group">
                                <input class="@error('email') is-invalid @enderror form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="email" name="email"
                                  value="{{ old('email') }}" required placeholder="Email" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <input id="password" class="@error('password') is-invalid @enderror form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="password"
                                  placeholder="Password" name="password" required autocomplete="new-password" />
                            </div>
                            <div class="form-group">
                                <input id="password-confirm" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="password" placeholder="Confirm Password" name="password_confirmation"
